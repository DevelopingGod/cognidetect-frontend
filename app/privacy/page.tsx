...
const sections = [
  {
    title: "1. Overview",
    content:
      "CogniDetect is designed with privacy as a core principle. This policy explains what data we collect, how it is used, and what protections are in place. We collect only what is strictly necessary to provide the screening service.",
  },
  {
  ...
  },
  {
    ...
    content:
      "We do NOT collect: your name, email address, phone number, IP address, device identifiers, location beyond country-level, facial data, video, or any other personally identifiable information. CogniDetect is designed to be fully anonymous.",
  },
  {
    title: "4. Audio Data",
    content:
  ...
  },
  {
    ...
    content:
      "Session records are stored in an SQLite database on the server infrastructure hosting the CogniDetect backend. Data is stored without personally identifiable fields and is accessible only to authorised administrators via the 2FA-protected admin panel.",
  },
  {
  ...
  },
  {
    ...
    content:
      "CogniDetect uses Google Translate API for multilingual UI translation. Text sent to Google Translate may be subject to Google's Privacy Policy. This applies only to UI labels and question text, not to your personal responses. We do not transmit your NLP answers to Google Translate.",
  },
  {
    title: "9. Cookies & Tracking",
    content:
      "CogniDetect does not use cookies for tracking or advertising. The application may use browser session storage to maintain state during your active screening session. This data is cleared when you close your browser tab.",
  },
  {
    title: "10. Security",
    content:
      "Access to the admin panel and raw session data is protected by two-factor authentication (password + TOTP). The backend API uses HTTPS in production. Audio files are auto-deleted. We follow reasonable security practices appropriate for a research prototype.",
  },
  {
  ...
  },
  {
    ...
    content:
      "CogniDetect is not designed for or directed at children under 18 years of age. We do not knowingly collect data from minors. If you believe a minor has used this tool without supervision, please contact us.",
  },
  {
