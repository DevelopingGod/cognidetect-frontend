...
const points = [
  {
    ...
    title: "Purpose",
    body: "This application is a Final Year (BE — Computer Engineering) project designed to screen for potential cognitive disorder patterns using Artificial Intelligence.",
  },
  {
    icon: AlertTriangle,
