...
export default function NLPSetupStep({
  ...
  const groups: SymptomGroup[] = [
    { key: "S1", label: "S1 – Attention / ADHD Symptoms", options: symptomOptions.S1 ?? [] },
    { key: "S2", label: "S2 – Mood / Depression Symptoms", options: symptomOptions.S2 ?? [] },
    { key: "S3", label: "S3 – Anxiety / Restlessness Symptoms", options: symptomOptions.S3 ?? [] },
    { key: "S4", label: "S4 – Social & Communication Symptoms", options: symptomOptions.S4 ?? [] },
    { key: "S5", label: "S5 – Routine / Repetitive Behaviour", options: symptomOptions.S5 ?? [] },
  ];
