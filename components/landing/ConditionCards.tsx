      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle max-w-2xl mx-auto">
            CogniDetectAI uses DSM-5 aligned criteria to screen for the five most
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          {/* Differentiator card — same format as condition cards */}
          <div
            className="card-hover group relative overflow-hidden"
          ...
          >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="font-bold text-lg">Differential</h3>
                  <span
                    className="text-xs px-2 py-0.5 rounded-full font-medium"
                    style={{ backgroundColor: "rgba(102,126,234,0.1)", color: "#667eea" }}
                  >
                    DSM-5
                  </span>
                </div>
                <p className="text-xs mb-2 font-medium" style={{ color: "#667eea" }}>
                  ASD · SPCD Differential Diagnosis
                </p>
