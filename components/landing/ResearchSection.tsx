...
const authors = [
  {
    ...
    note: "Sole architect of the entire system — AI pipeline, guardrails, UI, and research.",
    primary: true,
  },
  { name: "Dr. Monika Dangore", role: "Research Supervisor", primary: false },
  { name: "Aishwarya Borse", role: "Co-Author", primary: false },
  { name: "Rashi Madne", role: "Co-Author", primary: false },
];
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="section-title">
            Published at <span className="gradient-text">INSECT-2026</span>
          </h2>
          <p className="section-subtitle max-w-xl mx-auto">
            CogniDetect was developed as a BE final-year project and accepted
            for publication at an international conference.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4 pt-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h3 className="font-bold text-lg mb-1 leading-snug">
                CogniDetect: An AI-Powered Clinical Decision Support System for
              ...
              >
                ...
                <span>INSECT-2026 — International Conference on Emerging Technologies</span>
              </div>
            </div>
          </div>
        </div>
